 ...
 */
@Embeddable
public class HistNomSlotTimesPK implements Serializable {
    ...
    public HistNomSlotTimesPK() {
    }

    public HistNomSlotTimesPK(int id, String operationUser, Date operationTime) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HistNomSlotTimesPK)) {
            return false;
        }
        HistNomSlotTimesPK other = (HistNomSlotTimesPK) object;
        if (this.id != other.id) {
            return false;
        }
    ...
    public String toString() {
        return "org.su.stenata.model.HistNomSlotTimesPK[ id=" + id + ", operationUser=" + operationUser + ", operationTime=" + operationTime + " ]";
    }
