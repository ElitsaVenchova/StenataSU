 ...
 */
@Embeddable
public class HistNomZonesPK implements Serializable {
    ...
    public HistNomZonesPK() {
    }

    public HistNomZonesPK(int id, String operationUser, Date operationTime) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HistNomZonesPK)) {
            return false;
        }
        HistNomZonesPK other = (HistNomZonesPK) object;
        if (this.id != other.id) {
            return false;
        }
    ...
    public String toString() {
        return "org.su.stenata.model.HistNomZonesPK[ id=" + id + ", operationUser=" + operationUser + ", operationTime=" + operationTime + " ]";
    }
